...
# - obmc-phosphor-host-state-mgmt     - Phosphor OpenBMC host state management
...
FEATURE_PACKAGES_obmc-host-state-mgmt ?= "${@cf_enabled('obmc-phosphor-host-state-mgmt', 'virtual-obmc-host-state-mgmt', d)}"
