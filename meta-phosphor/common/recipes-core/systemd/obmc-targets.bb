...
POW_CHASSIS_ON_TMPL = "obmc-chassis-power{0}@.target"
POW_CHASSIS_ON = "obmc-power-chassis-{0}@.target"
POW_CHASSIS_ON_INSTFMT = "obmc-chassis-power{0}@.target"
...
SYSTEMD_SERVICE_${PN} += "${@compose_list(d, 'START_CHASSIS_POWON',  'CHASSIS_POWER_TARGETS')}"
