...
# Track all system action targets
SYSTEM_ACTION_TARGETS = "quiesce"
...
SYSTEM_ACTION_FMT = "obmc-{0}-system@.target"
...
SYSTEMD_SERVICE_${PN} += "${@compose_list(d, 'SYSTEM_ACTION_FMT', 'SYSTEM_ACTION_TARGETS')}"
