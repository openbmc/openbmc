...
#3START_POW_CHASSIS_ON_TMPL = "obmc-power-chassis-on@.target"
...
START_CHASSIS_POWON = "../${START_POW_CHASSIS_ON}.requires/obmc-chassis-poweron@{0}.target"
START_CHASSIS_POWOFF = "../${START_POW_CHASSIS_OFF}.requires/obmc-chassis-poweroff@{0}.target"
START_HOST_STOP = "../${START_CHASSIS_STOP}.requires/obmc-host-stop@{0}.target"
START_HOST_START = "../${START_CHASSIS_START}.requires/obmc-host-start@{0}.target"
START_HOST_SHUTDOWN = "../${START_STOP_HOST}.requires/obmc-host-shutdown@{0}.target"
