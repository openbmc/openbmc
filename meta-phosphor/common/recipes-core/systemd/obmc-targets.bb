...
START_POW_CHASSIS_ON_TMPL = "obmc-chassis-poweron@.target"
START_POW_CHASSIS_ON = "obmc-power-chassis-on@{1}.target"
START_POW_CHASSIS_ON_INSTFMT = "obmc-chassis-poweron@{0}.target"
START_POW_CHASSIS_OFF_TMPL = "obmc-chassis-poweroff@.target"
START_POW_CHASSIS_OFF = "obmc-power-chassis-off@{1}.target"
START_POW_CHASSIS_OFF_INSTFMT = "obmc-chassis-poweroff@{0}.target"
START_CHASSIS_STOP_TMPL = "obmc-host-stop@.target"
START_CHASSIS_STOP = "obmc-chassis-stop@{1}.target"
START_CHASSIS_STOP_INSTFMT = "obmc-host-stop@{0}.target"
START_CHASSIS_START_TMPL = "obmc-host-start@.target"
START_CHASSIS_START = "obmc-chassis-start@{1}.target"
START_CHASSIS_START_INSTFMT = "obmc-host-start@{0}.target"
START_STOP_HOST_TMPL = "obmc-host-shutdown@.target"
START_STOP_HOST = "obmc-stop-host@{1}.target"
START_STOP_HOST_INSTFMT = "obmc-host-shutdown@{0}.target"

START_CHASSIS_POWON = "../${START_POW_CHASSIS_ON_TMPL}:${START_POW_CHASSIS_ON}.requires/${START_POW_CHASSIS_ON_INSTFMT}"
START_CHASSIS_POWOFF = "../${START_POW_CHASSIS_OFF_TMPL}:${START_POW_CHASSIS_OFF}.requires/${START_POW_CHASSIS_OFF_INSTFMT}"
START_HOST_STOP = "../${START_CHASSIS_STOP_TMPL}:${START_CHASSIS_STOP}.requires/${START_CHASSIS_STOP_INSTFMT}"
START_HOST_START = "../${START_CHASSIS_START_TMPL}:${START_CHASSIS_START}.requires/${START_CHASSIS_START_INSTFMT}"
START_HOST_SHUTDOWN = "../${START_STOP_HOST_TMPL}:${START_STOP_HOST}.requires/${START_STOP_HOST_INSTFMT}"
