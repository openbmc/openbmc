...
do_install() {
    ...
    ls -l /var/lib/jenkins/workspace/openbmc-build-gerrit-trigger-multi/distro/ubuntu/target/palmetto/openbmc/build/tmp/sysroots/x86_64-linux/usr/lib/perl-native/perl/site_perl/5.22.1/mrw/Targets.pm
    echo "BAILING OUT"
    exit -1
}
