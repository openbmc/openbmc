...
DEPENDS_${PN}-ledmanager += "python-pyyaml-native"
DEPENDS_${PN}-ledmanager += "autoconf-archive-native"
DEPENDS_${PN}-ledmanager += "sdbusplus sdbusplus-native"
DEPENDS_${PN}-ledmanager += "phosphor-logging"

DEPENDS_${PN}-faultmonitor += "autoconf-archive-native"
DEPENDS_${PN}-faultmonitor += "sdbusplus sdbusplus-native"
DEPENDS_${PN}-faultmonitor += "phosphor-logging"
