...
do
  ...
  case "$rail" in
    ...
    vddb)
      ...
      ;;
    vcsa)
      rw_vc 4 0x71 4 1 $val
      ;;
    vcsb)
      rw_vc 5 0x71 4 1 $val
      ;;
    vdna)
      rw_vc 4 0x72 2 0 $val
      ;;
    vdnb)
      rw_vc 5 0x72 2 0 $val
      ;;
    vioa)
      rw_vc 4 0x40 2 x $val  # FIXME: What's the address for Romulus?
      ;;
    viob)
      rw_vc 5 0x40 2 x $val  # FIXME: What's the address for Romulus?
      ;;
    vddra)
      rw_vc 4 0x72 2 1 $val
      ;;
    vddrb)
      rw_vc 5 0x72 2 1 $val
      ;;
    vppa)
      rw_vc 12 0x41 2 x $val  # FIXME: What's the address for Romulus?
      ;;
    vppb)
      rw_vc 13 0x41 2 x $val  # FIXME: What's the address for Romulus?
      ;;
    vdnd)
      rw_vc 2 0x70 2 0 $val  # FIXME: What's the address for Romulus?
      ;;
    viod)
      rw_vc 2 0x70 2 1 $val  # FIXME: What's the address for Romulus?
      ;;
    *)
      echo "	non-existant"
  esac
