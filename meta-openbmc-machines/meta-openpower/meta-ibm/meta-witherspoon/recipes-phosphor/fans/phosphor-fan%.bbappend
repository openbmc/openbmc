...
SYSTEMD_OVERRIDE_phosphor-fan-control += "witherspoon-fan-watchdog-monitor.conf:phosphor-fan-control@0.service.d/witherspoon-fan-watchdog-monitor.conf"
SYSTEMD_OVERRIDE_phosphor-fan-monitor += "witherspoon-fan-watchdog-monitor.conf:phosphor-fan-monitor@0.service.d/witherspoon-fan-watchdog-monitor.conf"

#This service needs to be stopped when watchdog expires
SYSTEMD_OVERRIDE_phosphor-fan-monitor += "witherspoon-fan-watchdog-conflicts.conf:phosphor-fan-monitor@0.service.d/witherspoon-fan-watchdog-conflicts.conf"
