...
TMPL_IRBIND = "ir35221-bind@.service"
INSTFMT_IRBIND = "ir35221-bind@{0}.service"
FMT_IRBIND = "../${TMPL_IRBIND}:${TGTFMT}.requires/${INSTFMT_IRBIND}"

TMPL_IRUNBIND = "ir35221-unbind@.service"
INSTFMT_IRUNBIND = "ir35221-unbind@{0}.service"
FMT_IRUNBIND = "../${TMPL_IRUNBIND}:${TGTFMT}.requires/${INSTFMT_IRUNBIND}"

SYSTEMD_SERVICE_${PN} += "${TMPL} ${TMPL_IRUNBIND} ${TMPL_IRBIND}"
SYSTEMD_LINK_${PN} += "${@compose_list(d, 'FMT', 'OBMC_CHASSIS_INSTANCES')}"
SYSTEMD_LINK_${PN} += "${@compose_list(d, 'FMT_IRBIND', 'OBMC_CHASSIS_INSTANCES')}"
SYSTEMD_LINK_${PN} += "${@compose_list(d, 'FMT_IRUNBIND', 'OBMC_CHASSIS_INSTANCES')}"
