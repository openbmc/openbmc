...
SRC_URI:append:p10bmc = " file://com.ibm.Hardware.Chassis.Model.Balcones_dev_callouts.json"
...
FILES:${PN}:append:p10bmc = " ${datadir}/phosphor-logging/pels/com.ibm.Hardware.Chassis.Model.Balcones_dev_callouts.json"
...
do_install:append:p10bmc() {
    ...
    install -m 0644 ${UNPACKDIR}/com.ibm.Hardware.Chassis.Model.Balcones_dev_callouts.json ${D}/${datadir}/phosphor-logging/pels/com.ibm.Hardware.Chassis.Model.Balcones_dev_callouts.json
