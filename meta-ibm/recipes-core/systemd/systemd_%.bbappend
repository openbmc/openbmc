...
SRC_URI:append:ibm-enterprise = " file://journald-storage-policy.conf"
SRC_URI:append:ibm-enterprise = " file://systemd-journald-override.conf"
SRC_URI:append:ibm-enterprise = " file://journald-size-policy-16MB.conf"
SRC_URI:append:ibm-enterprise = " file://vm.conf"
SRC_URI:append:ibm-enterprise = " file://network.conf"
SRC_URI:append:ibm-enterprise = " file://systemd-networkd-only-wait-for-one.conf"
SRC_URI:append:ibm-enterprise = " file://systemd-sulogin-force.conf"
...
FILES:${PN}:append:ibm-enterprise = " ${systemd_unitdir}/journald.conf.d/journald-storage-policy.conf"
FILES:${PN}:append:ibm-enterprise = " ${systemd_system_unitdir}/systemd-journald.service.d/systemd-journald-override.conf"
FILES:${PN}:append:ibm-enterprise = " ${systemd_unitdir}/journald.conf.d/journald-size-policy.conf"
FILES:${PN}:append:ibm-enterprise = " ${sysconfdir}/sysctl.d/vm.conf"
FILES:${PN}:append:ibm-enterprise = " ${sysconfdir}/sysctl.d/network.conf"
FILES:${PN}:append:ibm-enterprise = " ${systemd_system_unitdir}/systemd-networkd-wait-online.service.d/systemd-networkd-only-wait-for-one.conf"
FILES:${PN}:append:ibm-enterprise = " ${systemd_system_unitdir}/emergency.service.d/systemd-sulogin-force.conf"
FILES:${PN}:append:ibm-enterprise = " ${systemd_system_unitdir}/rescue.service.d/systemd-sulogin-force.conf"
